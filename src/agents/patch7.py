"""
Meallion Voice AI - Elena English Agent (Patch 5)
...
async def entrypoint(ctx: JobContext):
    ...
    def _on_user_speech_committed(msg):
        ...
        if 7 <= len(all_digits) <= 9 and state.support_state == "awaiting_phone":
            ...
            # agent.interrupt() # Removed to prevent cutting off filler messages
            suppress_llm(10.0)
            snooze_silence(20.0)
    ...
    if human_input:
        ...
        def _on_interim_transcript(ev):
            ...
            if text:
                ...
                # FIX: Suppress LLM early if digits are detected in interim
