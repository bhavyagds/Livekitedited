"""
Meallion Voice AI - Elena English Agent (Patch 7)
...
Fix for "Thanks, got it. Give me a moment..." being cut off.
"""
    ...
    def _on_user_speech_committed(msg):
        ...
        if state.support_state in {"awaiting_order", "checking_order"}:
            ...
            if phone_candidate:
                ...
                asyncio.create_task(agent.say("Thanks, let me check that...", allow_interruptions=True))
            ...
            if order_id:
                ...
                asyncio.create_task(set_ui_state("thinking"))
                snooze_silence(20.0)
                asyncio.create_task(agent.say("Thanks, got it. Give me a moment...", allow_interruptions=True))
