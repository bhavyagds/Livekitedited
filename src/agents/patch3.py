"""
Meallion Voice AI - Elena English Agent (Patch 3)
Fixed version with prioritized phone extraction and hardened order ID logic.
"""
...
async def _run_order_lookup(agent: VoicePipelineAgent, order_number: str):
    ...
    try:
        ...
        if _is_order_not_found_text(result):
            ...
            # PATCH 3: Snooze silence monitor to allow user to process the "not found" message.
            snooze_silence(15.0)
        else:
